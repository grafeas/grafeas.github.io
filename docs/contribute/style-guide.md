---
title: Style Guide
overview: Explains the dos and donts of writing Grafeas docs.
...
TBD: This needs to be updated with Grafeas examples instead of Kubernetes examples.

This page gives writing style guidelines for the Grafeas documentation.
These are guidelines, not rules. Use your best judgment, and feel free to
propose changes to this document in a pull request.

For additional information on creating new content for the Grafeas
